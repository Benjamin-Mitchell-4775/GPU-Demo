...
def init_live_plots(err_ref):
    ...
    for ax, title, ylabel in [
        ...
        (ax_err,  "Position Error (X/Y/Z)", "Error [km]"),
    ]:
    ...
    plt.tight_layout()
    return (fig, ax_bank, ax_err,
            line_lstm, line_apollo,
...
def update_live_plots(fig, axes_lines, step,
    ...
    # Per-axis position error overlay (m → km)
